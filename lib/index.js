...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sortable = _createReactClass2['default']({
	  propTypes: {
	    ...
	    dragStartDelay: _propTypes2['default'].number
	  },
	  ...
	  componentDidUpdate: function componentDidUpdate() {
	    ...
	    var scrollTop = getScrollParent(container) || doc.docElement && doc.docElement.scrollTop || doc.body.scrollTop;
	   ...
	   */
	  handleMouseDown: function handleMouseDown(e, index, target) {
	    var _this2 = this;
	    ...
	    var startDrag = function startDrag() {
	      _this2._draggingIndex = index;
	      _this2._prevX = e.pageX || e.clientX;
	      _this2._prevY = e.pageY || e.clientY;
	      _this2._initOffset = e.offset;
	      _this2._initScrollOffset = {
	        scrollTop: scrollParent ? scrollParent.scrollTop : 0
	      };
	      _this2._isReadyForDragging = true;
	      _this2._hasInitDragging = false;
	    ...
	    if (this.props.dragStartDelay) {
	      (function () {
	        _this2._dragStartTimeout = setTimeout(function () {
	          return startDrag();
	        }, _this2.props.dragStartDelay);
	        var that = _this2;
	  ...
	  renderItems: function renderItems() {
	    ...
	    var items = _orderArr.map(function (itemIndex, index) {
	      var item = _this4.sortChildren[itemIndex];
	      if (!item) {
	        return;
	      }

	      if (index === _this4._draggingIndex && _this4.state.isDragging) {
	        draggingItem = _this4.renderDraggingItem(item);
	      }

	      var isPlaceHolder = _dimensionArr[index].isPlaceHolder;
	      var itemClassName = ('ui-sortable-item ' + (isPlaceHolder ? 'ui-sortable-placeholder' : '') + ' ' + (_this4.state.isDragging && isPlaceHolder ? 'visible' : '')).trim();

	      var sortableProps = {
	        sortableClassName: ((item.props.className || '') + ' ' + (itemClassName || '')).trim(),
	        sortableIndex: index,
	        onSortableItemReadyToMove: isPlaceHolder ? undefined : function (e, sortableIndex, target) {
	          _this4.handleMouseDown.call(_this4, e, index, target);
	        },
	        onSortableItemMount: _this4.handleChildUpdate,
	        sortHandle: _this4.props.sortHandle
	      };
	  ...
	  render: function render() {
	    var className = ('ui-sortable ' + (this.props.className || '')).trim();
	  ...
	  if (Component) {
	    return (function (_React$Component) {
	      ...
	      SortableItem.prototype.render = function render() {
	        ...
	        var
	        /* eslint-enable */
	        sortableClassName = _props.sortableClassName;
	        var sortableStyle = _props.sortableStyle;
	        var sortHandle = _props.sortHandle;

	        var rest = _objectWithoutProperties(_props, ['className', 'sortableIndex', 'sortableClassName', 'sortableStyle', 'sortHandle']);
